    ...
    <div className="min-h-screen bg-background text-foreground">
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-border bg-surface md:block">
        ...
        <div className="absolute inset-x-0 bottom-0 border-t border-border p-3">
          <Link
            to="/"
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-muted-foreground transition-colors hover:bg-surface-muted hover:text-foreground"
          >
            <Sparkles className="h-3.5 w-3.5" />
            Dashboard de privacidad diferencial
          </Link>
        </div>
      </aside>
    ...
    <main className="grid min-h-screen place-items-center bg-background px-4">
      <Card className="w-full max-w-sm rounded-lg">
        ...
        <CardContent>
          ...
          <Link
            to="/"
            className="mt-4 flex items-center justify-center gap-1.5 text-xs text-muted-foreground transition-colors hover:text-primary"
          >
            <Sparkles className="h-3.5 w-3.5" />
            Ir al dashboard de privacidad diferencial
          </Link>
        </CardContent>
      </Card>
    </main>
